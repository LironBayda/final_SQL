...
namespace PostgreSQL
{
    class PostgresSQL_AppConfig
    {
        ...
        public PostgresSQL_AppConfig()
        {
            Init("C:\\Users\\liron\\Source\\Repos\\finalSQL\\PostgreSQL\\PostgresSQL.config.json");
        }
        internal void Init(string file_name)
        {
            ...
            m_configRoot = (JObject)jo["PostgresSQLConfig"];
